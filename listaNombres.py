...
class ListaNombres:
    ...
    """
    Función "obtener_nombre_digipymon" para obtener de forma aleatoria un nombre de digipymon de la lista_nombres_digipymon.
    """
    ...
    """
    Función "obtener_nombre_entrenador" para obtener de forma aleatoria un nombre de entrenador de la lista_nombres_entrenadores.
    """
